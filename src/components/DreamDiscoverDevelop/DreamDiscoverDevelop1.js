...
import styles from './DreamDiscoverDevelop1.module.css';
...
const DreamDiscoverDevelop = (props) =>{
    ...
    function navigateToPartnerWithUs(){
        props.setScrollToPartnerWithUsHit(true);
    }

    return(<>
        <Letters fadeOut={true} />
            ...
            <div className={styles.flexboxRow2 } >
                ...
                <div className={styles.box4} >
                    <div className={styles.detail} >
                       <p className={styles.detailText} >At Desmantle, we are trying to define and spearhead 'Indian Design' of tomorrow.</p><br/>
                    ...
                    <div className={styles.flexboxColumn} >
                        <div className={styles.directionContainer} >
                            <div className={styles.direction1} onClick={navigateToPartnerWithUs} >Throw us a design challenge &#10230;</div>
                        </div>
                        <div className={styles.directionContainer} >
                            <a href="https://www.blog.desmantle.studio" target='_blank' rel="noreferrer" className={styles.direction2} >Read stories about Indian Design &#10230;</a>
                        </div>
                    </div>
                </div>
            </div>
